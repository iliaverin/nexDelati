...
bot = telebot.TeleBot('747528950:AAHOYrq1jhdepCebAlwyBoyD3VpAt8c0D2A')

SlovaNaD = 'https://synonymonline.ru/%D0%94'
...
def get_page_data ():
	headers = initHeaders()
	req = requests.get (SlovaNaD, headers = headers)
	soup = BeautifulSoup (req.text, 'lxml')

	coronovirus = soup.findAll ('div', {'class' : 'col-sm-4 col-xs-6'})
